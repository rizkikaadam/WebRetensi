                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a href="<?php echo base_url(); ?>Dretensi/tambah_data"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data</button></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table id="datatable-responsive" class="table table-striped projects">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                          <?php
                          $tgl_inaktif = $data_rekammedis->tgl_inaktif;
                          $berobat_terakhir = $data_rekammedis->berobat_terakhir;
                          $start_date = new DateTime($tgl_inaktif);
                          $end_date = new DateTime($tanggal_sekarang);
                          ...
                          {
                            echo "<button type='button' class='btn btn-warning btn-xs'>Inaktif</button>";
                            $status = '0';
                          }
                          ?>
                          </td>
                                      ...
                                      <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <input type='hidden' class="form-control" readonly="readonly" name="no_rekammedis" value="<?php echo $data_rekammedis->no_rekammedis; ?>" />
                                            <input type='hidden' class="form-control" readonly="readonly" name="status" value="<?php echo $status ?>" />
                                            <div class="form-group">
